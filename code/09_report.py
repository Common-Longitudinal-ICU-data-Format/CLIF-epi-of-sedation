...
def _():
    ...
    **Pages (in order):**
    ...
    10. Marginal effects (Linear) — SBT Done Next Day (GEE)

    11. Marginal effects (Linear) — Successful Extubation (GEE)

    12. Marginal effects (Linear) — Successful Extubation (Logit)

    13. Marginal effects (RCS) — SBT Done Next Day (GEE)

    14. Marginal effects (RCS) — Successful Extubation (GEE)

    15. Marginal effects (RCS) — Successful Extubation (Logit)
    """)
    return
...
def _(
    ...
    with PdfPages(_pdf_path) as _pdf:
        ...
        # Pages 10-12: Linear marginal effect plots (sofa spec).
        ...
        # Pages 13-15: RCS marginal effect plots (sofa_rcs spec).
